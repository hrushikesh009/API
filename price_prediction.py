...
def method_name():
    ...
    given_sub = dataset['given_sub']
    dataset.pop("given_sub")
    fashion_dataset = tc.SFrame.read_json(dataset, orient = 'lines')
    ...
    model = tc.load_model("/content/drive/My Drive/final_linear.model")
